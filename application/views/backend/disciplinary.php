                                           ...
                                           <?php foreach($desciplinary as $value): ?>
                                            <tr>
                                                ...
                                                <td  class="jsgrid-align-center ">
                                                    ...
                                                    <a href="DeletDisiplinary?D=<?php echo $value->id; ?>" onclick="return confirm('Are you sure want to delet this value?')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
