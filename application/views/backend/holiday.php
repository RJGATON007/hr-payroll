                                           ...
                                           <?php foreach($holidays as $value): ?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a onclick="return confirm('Are you sure want to delete this Value?')" href="#" title="Delete" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> hidden <?php } ?> class="btn btn-sm btn-info waves-effect waves-light holidelet" data-id="<?php echo $value->id; ?>"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.holiday', function (e) {
        e.preventDefault();
        var iid = $(this).attr('data-id');
        $('#holidayform').trigger("reset");
        $('#holysmodel').modal('show');
