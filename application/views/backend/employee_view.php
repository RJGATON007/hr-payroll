				                                ...
				                                <form class="row" action="Update" method="post" enctype="multipart/form-data">
                                                   ...
                                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } else { ?> 
				                                    ...
				                                    <div class="form-group col-md-4 m-t-10">
				                                        ...
				                                        <input type="text" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control"placeholder="TIN Number" name="nid" value="<?php echo $basic->em_nid; ?>" minlength="10" required> 
				                                    </div>
				                                    <div class="form-group col-md-4 m-t-10">
                                ...
                                <tr>
                                   ...
                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        ...
                                        <a onclick="return confirm('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light edudelet"  data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       ...
                                       <?php } else { ?>
                                        ...
                                        <a onclick="return confirm('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light deletexp" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
