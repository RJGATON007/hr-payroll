                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#client" role="tab">  Client Information </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#office" role="tab">Assign tasks </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tasks" role="tab">Project tasks </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#field" role="tab">Field tasks </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#education" role="tab"> Project files</a> </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> 
                                    ...
                                    <!-- <// updated script 10/15/2024// > -->
                                    <?php
                                        // Calculate the progress percentage based on start and end dates
                                        $start_date = strtotime($details->pro_start_date);
                                        $end_date = strtotime($details->pro_end_date);
                                        $current_date = time();
                                    ...
                                    ?>
                                    <div class="progress-value"><?php echo round($progress); ?>%</div>
                                    </div>
                                    </div>                            
                                    <!--end progress-->                                   
                                    ...
                                    <div class="card">
				                        <div class="card-body">
                                    <form method="post" action="Update_Project" id="btnSubmit" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-footer">
                                       <input type="hidden" name="proid" value="<?php echo $details->id; ?>">
                                        <button type="button" class="btn btn-default" onclick="window.location.href='<?php echo base_url('Projects/All_Projects'); ?>'">Close</button>
                                        <button type="submit" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> disabled <?php } ?> class="btn btn-primary">Update</button>
                                    </div>
                                    </form>
				                        </div>
                                    </div>                                           
                                ...
                                <!--client information sheet tab-->
                                <div class="tab-pane" id="client" role="tabpanel">
                                <form method="post" action="<?php echo base_url('Projects/updateProject'); ?>" id="btnSubmit" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="clientname" class="form-control" id="recipient-name1" value="<?php echo $details->client_name; ?>" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Birthday</label>
                                                        <input type="date" name="dob" class="form-control" id="recipient-name1" value="<?php echo $details->dob; ?>" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Age</label>
                                                        <input type="number" name="age" class="form-control" id="recipient-name1" value="<?php echo $details->age; ?>" placeholder="">
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control custom-select" data-placeholder="Choose a Religion" tabindex="1" name="religion">
                                                            <option value="Roman Catholic" <?php echo ($details->religion == 'Roman Catholic') ? 'selected' : ''; ?>>Roman Catholic</option>
                                                            <option value="Born Again Christian" <?php echo ($details->religion == 'Born Again Christian') ? 'selected' : ''; ?>>Born Again Christian</option>
                                                            <option value="Muslim" <?php echo ($details->religion == 'Muslim') ? 'selected' : ''; ?>>Muslim</option>
                                                            <option value="INC" <?php echo ($details->religion == 'INC') ? 'selected' : ''; ?>>INC</option>
                                                            <option value="Mormons" <?php echo ($details->religion == 'Mormons') ? 'selected' : ''; ?>>Mormons</option>
                                                            <option value="Seventh day adventist" <?php echo ($details->religion == 'Seventh day adventist') ? 'selected' : ''; ?>>Seventh day adventist</option>
                                                            <option value="Jehove witneses" <?php echo ($details->religion == 'Jehove witneses') ? 'selected' : ''; ?>>Jehova's witneses</option>
                                                            <option value="Protestant" <?php echo ($details->religion == 'Protestant') ? 'selected' : ''; ?>>Protestant</option>
                                                            <option value="other" <?php echo ($details->religion == 'other') ? 'selected' : ''; ?>>Other</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Marital Status</label>
                                                        <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="maritalstatus">
                                                            ...
                                                            <option value="widowed" <?php echo ($details->marital_status == 'widowed') ? 'selected' : ''; ?>>Widowed</option>
                                                            <option value="separated" <?php echo ($details->marital_status == 'separated') ? 'selected' : ''; ?>>Separated</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Nationality</label>
                                                        <select class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1" name="nationality">
                                                            <option value="Filipino" <?php echo ($details->nationality == 'Filipino') ? 'selected' : ''; ?>>Filipino</option>
                                                            <option value="American" <?php echo ($details->nationality == 'American') ? 'selected' : ''; ?>>American</option>
                                                            <option value="Chinese" <?php echo ($details->nationality == 'Chinese') ? 'selected' : ''; ?>>Chinese</option>
                                                            <option value="Japanese" <?php echo ($details->nationality == 'Japanese') ? 'selected' : ''; ?>>Japanese</option>
                                                            <option value="Korean" <?php echo ($details->nationality == 'Korean') ? 'selected' : ''; ?> >Korean</option>
                                                            <option value="Indian" <?php echo ($details->nationality == 'Indian') ? 'selected' : ''; ?> >Indian</option>
                                                            <option value="other" <?php echo ($details->nationality == 'Other') ? 'selected' : ''; ?> >Other</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="control-label">Occupation</label>
                                                        <input type="text" name="occupation" class="form-control" id="recipient-name1" value="<?php echo $details->occupation; ?>" placeholder="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h3 class="m-b-0 text-themecolor text-center" style="margin-bottom: 40px;">ADDRESS AND CONTACT INFORMATION</h3>
                                                </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Barangay/Street</label>
                                                            <input type="text" name="brgy" class="form-control" id="recipient-name1" value="<?php echo $details->brgy; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">City/Municipality</label>
                                                            <input type="text" name="mun" class="form-control" id="recipient-name1" value="<?php echo $details->mun; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Province/Region</label>
                                                            <input type="text" name="prov" class="form-control" id="recipient-name1" value="<?php echo $details->prov; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Zip Code</label>
                                                            <input type="text" name="zip" class="form-control" id="recipient-name1" value="<?php echo $details->zip; ?>" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="control-label">Contact Number</label>
                                                            <input type="text" name="contactno" class="form-control" id="recipient-name1" value="<?php echo $details->contact_no; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Email</label>
                                                            <input type="email" name="clientemail" class="form-control" id="recipient-name1" value="<?php echo $details->client_email; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Emergency Contact Person</label>
                                                            <input type="text" name="emergencycontactperson" class="form-control" id="recipient-name1" value="<?php echo $details->emergency_contact_person; ?>" placeholder="">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label">Emergency Contact Number</label>
                                                            <input type="text" name="emergencycontactnumber" class="form-control" id="recipient-name1" value="<?php echo $details->emergency_contact_number; ?>" placeholder="">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <input type="hidden" name="client" value="<?php echo $details->id; ?>">
                                                        <button type="button" class="btn btn-default" onclick="window.location.href='<?php echo base_url('Projects/All_Projects'); ?>'">Close</button>
                                                    ...
                                                    <?php foreach($tasklist as $value): ?>
                                                        <tr>
                                                            ...
                                                            <td class="jsgrid-align-center ">
                                                                ...
                                                                <a onclick="return confirm('Are you sure want to delete this Value?')" href="#" title="Delete" class="btn btn-sm btn-info waves-effect waves-light TasksDelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                                            </td>
                                                            <?php } ?>
                                                        </tr>
                                                        <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                        ...
                                        <a href="#" onclick="return confirm('are you sure want to delete this value')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light exdelet" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
