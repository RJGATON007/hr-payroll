                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    ?>  Employees</h3>
                                        <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0"> </a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>leave/Application" class="text-muted m-b-0"> </a>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0"> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="to-do-widget m-t-20" style="height:600px;overflow-y:scroll">
