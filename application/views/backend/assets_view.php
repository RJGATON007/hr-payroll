...
<!--                                                <td><?php echo $value->ass_id ?></td>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                    ...
                                                    <a href="AssetsDelet?D=<?php echo $value->ass_id; ?>" onclick="return confirm('Are you Sure??')" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
